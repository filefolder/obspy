...
class PolesZerosResponseStage(ResponseStage):
    ...
    def get_response(self, frequencies, fast=True):
        ...
        if len(frequencies) > 10000 and fast:
            ...
            #amp = scipy.interpolate.UnivariateSpline(resp_frequencies, amp, k=3, s=len(resp_frequencies)/2)(frequencies)
            #phase = scipy.interpolate.UnivariateSpline(resp_frequencies, phase, k=3, s=len(resp_frequencies)/2 )(frequencies)
