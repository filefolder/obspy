...
#define EXIT(code) \
    ...
    *stime = 0.0f;
    ...
    // now sta/lta
    nsta = (int)(sta_p*sample_rate*sta_p);
    nlta = (int)(lta_p*sample_rate*lta_p);
    stlt = 0.;
    ...
    *ptime = ((float) (i4-nl_p)) / sample_rate;
    ...
    if(s_pick == 1){
        ...
        // now sta-lta
        nsta = (int)(sta_s*sample_rate*sta_s);
        nlta = (int)(lta_s*sample_rate*lta_s);
        //stlt = 0.;
        ...
        if(i6 > 0 && i6 > i4){
            ...
            // S-onset time, changed to return seconds
            if(i7 > 0 && i7 > i4) {
